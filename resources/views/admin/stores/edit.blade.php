                    ...
                    <form action="{{ route('admin.stores.update', $store) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('address') is-invalid @enderror" 
                                      id="address" name="address" rows="3" required>{{ old('address', $store->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                    ...
                                    @if($store->image_path)
                                        <div class="mt-2">
                                            ...
                                            <img src="{{ asset('storage/' . $store->image_path) }}" 
                                                 alt="Store Image" class="img-thumbnail" style="max-width: 100px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                               value="1" {{ old('is_active', $store->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.stores.show', $store) }}" class="btn btn-secondary">
